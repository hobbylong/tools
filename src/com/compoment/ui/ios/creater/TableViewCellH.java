...
public class TableViewCellH {
	...
	public void chirld(CompomentBean chirld, CompomentBean parent) {
		...
		if (chirld.type.equals("TextView")) {
			n+="//"+chirld.cnname+"\n";
			n+="@property (weak, nonatomic) IBOutlet UILabel *"+chirld.enname+";\n";
		...
		if (chirld.type.equals("EditText")) {
			n+="//"+chirld.cnname+"\n";
			n+="@property (weak, nonatomic) IBOutlet UITextField *"+chirld.enname+";\n";
		...
		if (chirld.type.equals("CheckBox")) {
			...
			n+="@property (weak, nonatomic) IBOutlet UILabel *"+chirld.enname+"Cover;\n";
		...
		if (chirld.type.equals("ImageView")) {
			n+="//"+chirld.cnname+"\n";
			n+="@property (weak, nonatomic) IBOutlet UIImageView *"+chirld.enname+";\n";
		}
