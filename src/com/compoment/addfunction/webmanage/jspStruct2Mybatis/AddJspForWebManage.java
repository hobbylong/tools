...
public class AddJspForWebManage {

	public AddJspForWebManage(List<InterfaceBean> interfaceBeans) {
...

	{
		...
		m+=" <form action=\"<%=basePath%>"+interfaceBean.enName+"Action!doAdd\" method=\"post\" enctype=\"multipart/form-data\" name=\"myForm\">\n";
