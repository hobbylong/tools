...
public class UpdateJspForServlet {

	public UpdateJspForServlet(List<InterfaceBean> interfaceBeans) {
...

	{
		...
		m+=" <form action=\"<%=basePath%>"+interfaceBean.enName+"Servlet?method=doUpdate\" method=\"post\" enctype=\"multipart/form-data\" name=\"myForm\">\n";
