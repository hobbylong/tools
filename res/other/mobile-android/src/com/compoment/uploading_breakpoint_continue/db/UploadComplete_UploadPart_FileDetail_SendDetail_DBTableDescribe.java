...
/*
 *
 * 多张表结构（message_uploading表 等。。。。）
 */
public final class UploadComplete_UploadPart_FileDetail_SendDetail_DBTableDescribe {
	public static final String AUTHORITY = "com.compoment.uploading_breakpoint_continue.db.UploadComplete_UploadPart_FileDetail_SendDetail_DBContentProvider";
	...
	public static final String TABLE_UPLOAD_PART = "file_upload_part";
	...
	protected interface FileUploadPartColumns {
	...
	protected interface MessageSentColumns {
		...
		public static final String MESSAGE_RECORD_ID = "rcd_id"; // 留言文件id
